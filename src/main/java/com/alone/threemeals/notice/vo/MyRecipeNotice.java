...
public class MyRecipeNotice {
	...
	public MyRecipeNotice() {
		// TODO Auto-generated constructor stub
	}

	public MyRecipeNotice(int n_Seq, String n_Title, Date n_RegDate, String n_Writer, int n_Star, String n_Picture,
	...
	public String toString() {
		return "MyRecipeNotice [n_Seq=" + n_Seq + ", n_Title=" + n_Title + ", n_RegDate=" + n_RegDate + ", n_Writer="
				+ n_Writer + ", n_Star=" + n_Star + ", n_Picture=" + n_Picture + ", n_File=" + n_File + ", n_Content="
