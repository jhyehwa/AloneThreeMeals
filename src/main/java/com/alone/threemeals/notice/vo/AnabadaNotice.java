...
public class AnabadaNotice {
	...
	public AnabadaNotice() {
		// TODO Auto-generated constructor stub
	}

	public AnabadaNotice(int n_Seq, String n_Title, Date n_RegDate, String n_Writer, String n_Content, int n_Hit,
	...
	public String toString() {
		return "AnabadaNotice [n_Seq=" + n_Seq + ", n_Title=" + n_Title + ", n_RegDate=" + n_RegDate + ", n_Writer="
