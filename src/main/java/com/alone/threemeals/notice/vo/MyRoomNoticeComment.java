...
public class MyRoomNoticeComment {
	private int c_Seq;
	private int n_Seq;
	...
	public MyRoomNoticeComment() {
		// TODO Auto-generated constructor stub
	}
	public MyRoomNoticeComment(int c_Seq, int n_Seq, Date c_RegDate, String c_Writer, String c_Content, String c_Grok) {
		super();
		this.c_Seq = c_Seq;
		this.n_Seq = n_Seq;
