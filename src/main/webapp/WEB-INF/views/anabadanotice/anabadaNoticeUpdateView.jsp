...
<link rel="stylesheet" href="resources/style/AnabadaNoticeRegView.css"
	type="text/css">
...
$(function() {
	...
	$('#login_result').hide();
	$('#login_Id, #login_Pwd').keydown(function(){
   		login();
...
<body>
	<div id="wrapper">
      ...
      <form id="loginAtion" action="loginProcess" method="post">
		...
		<form id="noticeInput" action="anabadaNoticeUpdateProcess" method="post">
			<div id="content">
				<div id="place1">
					<img src="resources/images/place6_6.png" />
				</div>
				<div id="top">
					<div id="title">
						<input type="hidden" id="n_Seq" name="n_Seq" value="${anabada.n_Seq}" />
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="n_Title" name="n_Title" value="${anabada.n_Title}"/><br /><br />
						 작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="n_Writer" name="n_Writer" value="${anabada.n_Writer}"
							readonly="readonly" /><br /><br />
					</div>
					<div id="bottom">
						<textarea rows="20" cols="50" id="n_Content" name="n_Content">${anabada.n_Content}</textarea>
					</div>
					<div>
