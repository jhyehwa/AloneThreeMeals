...
<link rel="stylesheet" href="resources/style/AnabadaNoticeList.css"
   type="text/css">
	...
	$(function() {
		...
		$('.page').click(
				function() {
					...
					$(this).attr(
							'href',
							'anabadaNoticeList?find=' + find + '&qtext=' + qtext
									+ '&currPage=' + currPage);
				});
...
<div id="wrapper">
      ...
      <form action="anabadaNoticeList" method="get">
      <div class="place">
      ...
      <div class="notice">
        ...
        <c:if test="${anabadalist.size() > 0}">
            <c:forEach var="i" begin="0" end="${anabadalist.size()-1}">
               <ul class="content">
                  <li class="n_Seq">${anabadalist[i].n_Seq}</li>
                  <li class="n_Title"><a href="anabadaNoticeDetail?n_Seq=${anabadalist[i].n_Seq}">${anabadalist[i].n_Title}</a></li>
                  <li class="n_Writer">${anabadalist[i].n_Writer}</li>
                  ...
                  <li class="n_Hit">${anabadalist[i].n_Hit}</li>
               </ul>
            </c:forEach>
         </c:if>
     </div>
     <form id="regProcess" action="anabadaNoticeRegView" method="post">
     <div id="reg">
