...
<body>
	<div id="wrapper">
      ...
      <form id="loginAtion" action="loginProcess" method="post">
		...
		<form id="noticeInput" action="anabadaNoticeRegProcess" method="post">
			<div id="content">
				<div id="place1">
				...
				<div id="top">
					<div id="title">
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="n_Title" name="n_Title" /><br /><br />
						 작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="n_Writer" name="n_Writer" value="${m_Id}" readonly="readonly" /><br /><br />
					</div>
					<div id="bottom">
