...
<link rel="stylesheet" href="resources/style/HoneyTipNoticeList.css"
   type="text/css">
	...
	$(function() {
		...
		$('.page').click(
				function() {
					...
					$(this).attr(
							'href',
							'honeyTipNoticeList?find=' + find + '&qtext=' + qtext
									+ '&currPage=' + currPage);
				});
...
<div id="wrapper">
      ...
      <div class="notice">
        ...
        <c:if test="${honeyTiplist.size() > 0}">
            <c:forEach var="i" begin="0" end="${honeyTiplist.size()-1}">
               <ul>
                  <li class="n_Seq">${honeyTiplist[i].n_Seq}</li>
                  <li class="n_Title"><a href="honeyTipNoticeDetail?n_Seq=${honeyTiplist[i].n_Seq}">${honeyTiplist[i].n_Title}</a></li>
                  <li class="n_Writer">${honeyTiplist[i].n_Writer}</li>
                  ...
                  <li class="n_Hit">${honeyTiplist[i].n_Hit}</li>
               </ul>
            </c:forEach>
         </c:if>
     </div>
      <form id="regProcess" action="honeyTipNoticeRegView" method="post">
     <div id="reg">
