...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="resources/style/MyRecipeNoticeRegView.css"
	type="text/css">

<link href="resources/style/HoneyTipNoticeUpdateView.css" rel="stylesheet">
...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="honeyTipNoticeUpdateProcess" method="post" enctype="multipart/form-data">
			<div id="content">
         		<div id="place1">
            		<img src="resources/images/place7_7.png" />
         		</div>
         		<div id="top">
					<div id="title">
					    <input type="hidden" id="n_Seq" name="n_Seq" value="${honeyTip.n_Seq}" />
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 <input type="text" id="n_Title" name="n_Title" value="${honeyTip.n_Title}"/><br /><br />
						작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자 <input type="text" id="n_Writer" name="n_Writer" value="${honeyTip.n_Writer}" readonly="readonly"/><br />
						<br /><br />
						<br />
					</div>
					<div id="bottom">
						<textarea rows="20" cols="50" id="n_Content" name="n_Content">${honeyTip.n_Content}</textarea>
					</div>
					<div>
