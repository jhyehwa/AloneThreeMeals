...
<link rel="stylesheet" href="resources/style/NecessityNoticeList.css"
   type="text/css">
...
$(function(){
	   $('#login_result').hide();
	      ...
	      $('.page').click(function(){
	    	  ...
	    	  $(this).attr('href','necessityNoticeList?find='+find+'&qtext='+qtext+'&currPage='+currPage);
...
<div id="wrapper">
      ...
      <form action="necessityNoticeList" method="get">
      <div class="place">
      ...
      <div class="notice">
        ...
        <c:if test="${necessitylist.size() > 0}">
            <c:forEach var="i" begin="0" end="${necessitylist.size()-1}">
               <ul>
                  <li class="n_Seq">${necessitylist[i].n_Seq}</li>
                  <li class="n_Title"><a href="necessityNoticeDetail?n_Seq=${necessitylist[i].n_Seq}">${necessitylist[i].n_Title}</a></li>
                  <li class="n_Writer">${necessitylist[i].n_Writer}</li>
                  ...
                  <li class="n_Hit">${necessitylist[i].n_Hit}</li>
               </ul>
            </c:forEach>
         </c:if>
     </div>
     <form id="regProcess" action="necessityNoticeRegView" method="post">
     <div id="reg">
