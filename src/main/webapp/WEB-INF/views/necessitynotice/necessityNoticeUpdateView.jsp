...
<link rel="stylesheet" href="resources/style/NecessityNoticeUpdateView.css" type="text/css">
...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="necessityNoticeUpdateProcess" method="post">
			<div id="content">
         		<div id="place1">
            		<img src="resources/images/place10_10.png" />
         		</div>
         		<div id="top">
					<div id="title">
						<br /><br />
						<input type="hidden" id="n_Seq" name="n_Seq" value="${necessity.n_Seq}" />
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="n_Title" name="n_Title" value="${necessity.n_Title}"/><br /><br />
						작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자 &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="n_Writer" name="n_Writer" value="${necessity.n_Writer}" readonly="readonly"/><br /><br />
						<br /><br />
					</div>
					<div id="bottom">
						<textarea rows="20" cols="50" id="n_Content" name="n_Content">${necessity.n_Content}</textarea>
					</div>
					<div>
