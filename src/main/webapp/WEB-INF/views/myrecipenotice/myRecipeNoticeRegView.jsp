...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="myRecipeNoticeRegProcess" method="post" enctype="multipart/form-data">
			<div id="content">
         		<div id="place1">
         		...
         		<div id="top">
					<div id="title">
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 <input type="text" id="n_Title" name="n_Title" /><br /><br />
						작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자 <input type="text" id="n_Writer" name="n_Writer" value="${m_Id}" readonly="readonly"/><br /><br />
						파&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;일<input type="file" id="n_File" name="n_File" /><br /><br />
					</div>
					<div class="stars">
						난&nbsp;&nbsp;&nbsp;&nbsp;이&nbsp;&nbsp;&nbsp;&nbsp;도<input class="star star-5" id="star-5" type="radio" name="star" value="5"/> 
					...
					<div id="bottom">
						<textarea rows="20" cols="50" id="n_Content" name="n_Content"></textarea>
					</div>
					<div>
