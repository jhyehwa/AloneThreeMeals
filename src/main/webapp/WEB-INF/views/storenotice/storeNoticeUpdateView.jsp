...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="resources/style/StoreNoticeUpdateView.css"
	type="text/css">

<link href="resources/style/StoreNoticeUpdateView.css" rel="stylesheet">
...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="storeNoticeUpdateProcess" method="post" enctype="multipart/form-data">
			<div id="content">
         		<div id="place1">
            		<img src="resources/images/place5_5.png" />
         		</div>
         		<div id="top">
					<div id="title">
					    <input type="hidden" id="n_Seq" name="n_Seq" value="${store.n_Seq}" />
						제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 <input type="text" id="n_Title" name="n_Title" value="${store.n_Title}"/><br /><br />
						작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자 <input type="text" id="n_Writer" name="n_Writer" value="${store.n_Writer}" readonly="readonly"/><br /><br />
						파&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;일 <input type="file" id="n_File" name="n_File"  /><br /><br />
					</div>
					<div class="stars">
						평&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;점
							<input type="hidden"  id="starCk" value="${store.n_Star}" />
					...
					<div id="photo">
                  		<img id="img" alt="" src="upload/${store.n_Picture}"><br />
               		</div>
					<div id="bottom">
						<textarea rows="20" cols="50" id="n_Content" name="n_Content">${store.n_Content}</textarea>
					</div>
					<div>
