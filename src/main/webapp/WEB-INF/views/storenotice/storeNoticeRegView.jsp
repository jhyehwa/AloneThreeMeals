...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="resources/style/StoreNoticeRegView.css"
	type="text/css">
...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="storeNoticeRegProcess" method="post" enctype="multipart/form-data">
			<div id="content">
         		<div id="place1">
         		...
         		<div id="top">
					...
					<div class="stars">
						평&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;점<input class="star star-5" id="star-5" type="radio" name="star" value="5"/> 
