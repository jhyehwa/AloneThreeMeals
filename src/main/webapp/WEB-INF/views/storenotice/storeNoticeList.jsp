...
<link rel="stylesheet" href="resources/style/StoreNoticeList.css"
   type="text/css">
<script>
$(function(){
   $('#login_result').hide();
      ...
      $('.page').click(function(){
    	  ...
    	  $(this).attr('href','storeNoticeList?find='+find+'&qtext='+qtext+'&currPage='+currPage);
...
<body>
   <div id="wrapper">
      ...
      <form action="storeNoticeList" method="get">
      <div class="place">
        ...
        <c:if test="${storelist.size() > 0}">
            <c:forEach var="i" begin="0" end="${storelist.size()-1}">
               <ul>
                  ...
                  <li class="n_Picture"><a href="storeNoticeDetail?n_Seq=${storelist[i].n_Seq}"><img class="recipeImg" src="upload/${storelist[i].n_Picture}" width="228" height="228"/></a></li>
                  ...
                  <li class="n_Hit">${storelist[i].n_Hit}</li>
               </ul>
            </c:forEach>
         </c:if>
     </div>
     <form id="regProcess" action="storeNoticeRegView" method="post">
     <div id="reg">
