...
<link
   ...
   rel="stylesheet">
<link rel="stylesheet" href="resources/style/CookRegView.css" type="text/css">
...
<div id="wrapper">
   ...
   <form id="cookInput" action="cookRegProcess" method="post" enctype="multipart/form-data">
      <div id="content">
         <div id="place1">
            ...
            <div id="top">
               <div id="title">
                 	 요&nbsp;&nbsp;&nbsp;&nbsp;리&nbsp;&nbsp;&nbsp;&nbsp;명
                  	<input type="text" id="c_Name" name="c_Name" size="79" /><br /><br />
                  	주&nbsp;&nbsp;&nbsp;&nbsp;재&nbsp;&nbsp;&nbsp;&nbsp;료
                  	<input type="text" id="main_Ingredient" name="main_Ingredient" size="79" /><br /><br /> 
                 	 작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자
               ...
               <div id="bottom">
                  <textarea rows="20" cols="55" id="c_Recipe" name="c_Recipe"></textarea>
               </div>
