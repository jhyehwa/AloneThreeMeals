...
<link rel="stylesheet" href="resources/style/CookUpdateView.css" type="text/css">
...
$(function() {
	...
	$('#write').click(function() {
   	 ...
   	 var c_File = $('#c_File').val();
   	 var c_Recipe = $('#c_Recipe').val();
		...
		var aHTML = $('#c_Recipe').code();
		$('#c_Recipe').html(aHTML);
		var summernote = $('#c_Recipe').val();
...
<body>
	<div id="wrapper">
		...
		<form id="noticeInput" action="cookUpdateProcess" method="post" enctype="multipart/form-data">
			<div id="content">
         		<div id="place1">
            		<img src="resources/images/place4_4.png" />
         		</div>
         		<div id="top">
					<div id="title">
					    <input type="hidden" id="c_Id" name="c_Id" value="${cook.c_Id }" />
							요&nbsp;&nbsp;&nbsp;&nbsp;리&nbsp;&nbsp;&nbsp;&nbsp;명
							<input type="text" id="c_Name" name="c_Name" size="79" value="${cook.c_Name}"/><br /><br />
                 	      	주&nbsp;&nbsp;&nbsp;&nbsp;재&nbsp;&nbsp;&nbsp;&nbsp;료
                 	      	<input type="text" id="main_Ingredient" name="main_Ingredient" size="79" value="${cook.main_Ingredient}"/><br /><br /> 
                           	작&nbsp;&nbsp;&nbsp;&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;자
                           	<input type="text" value="admin" readonly="readonly" size="79" /><br /><br />
                  			파&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;일
                  			<input type="file" id="c_File" name="c_File" /><br /><br />
					</div>
					<div id="photo">
                  		<img id="img" alt="" src="upload/${cook.c_Picture}"><br />
               		</div>
					<div id="bottom">
						<textarea rows="20" cols="55" id="c_Recipe" name="c_Recipe">${cook.c_Recipe}</textarea>
					</div>
					<div>
